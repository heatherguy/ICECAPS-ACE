...
if today.hour != 0: 
    ...
    fig.tight_layout()
    fig.savefig('/home/fluxtower/Data/Ncounts_current.png')
else:            
    fig = plt.figure(figsize=(17,4))
    ax = fig.add_subplot(111)
    ax.grid(True)
    ...
    ax.legend(loc='best',fontsize=10)
    fig.tight_layout()
    fig.savefig('/home/fluxtower/Data/Ncounts_plot_archive/Ncounts_%s.png'%dt.datetime.strftime(yesterday,'%Y-%m-%d'))
